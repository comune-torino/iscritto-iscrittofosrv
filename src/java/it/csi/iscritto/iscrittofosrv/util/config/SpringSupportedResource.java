...
public abstract class SpringSupportedResource {
	 ...
	 * 
	 * @param name
	 *            il nome del servizio jax-rs. In caso di implememtazione diretta coincide con il nome della classe, mentre in caso di implementazione indiretta
	 *            (ovvero interface annotata alla jax-rs + classe di implementazione che estende da essa) occorre verificare il match del nome servizio con il
	 *            nome dell'interfaccia impleentata.
