package it.csi.iscritto.iscrittofosrv.util.sql;

import static it.csi.iscritto.iscrittofosrv.util.LoggingUtils.LOG_BEGIN_QUERY;
import static it.csi.iscritto.iscrittofosrv.util.LoggingUtils.LOG_END_QUERY;
