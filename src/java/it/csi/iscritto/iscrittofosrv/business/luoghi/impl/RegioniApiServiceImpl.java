...
import it.csi.iscritto.iscrittofosrv.business.luoghi.RegioniApi;
...
public class RegioniApiServiceImpl extends SpringSupportedResource implements RegioniApi {
	...
	@Override
	public Response getElencoRegioniAttive(SecurityContext sc, HttpServletRequest request) {
		...
		try {
			...
			List<Regione> result = this.luoghiService.getElencoRegioniAttive(callerInfo);
	...
	@Override
	public Response getElencoRegioniAttiveAllaData(SecurityContext sc, HttpServletRequest request, String data) {
		...
		try {
			...
			List<Regione> result = this.luoghiService.getElencoRegioniAttiveAllaData(
