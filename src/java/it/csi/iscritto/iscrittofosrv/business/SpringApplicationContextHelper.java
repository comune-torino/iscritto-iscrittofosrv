...
import it.csi.iscritto.iscrittofosrv.util.config.AppServletContextListener;
...
public class SpringApplicationContextHelper implements ApplicationContextAware {
	...
	/**
	 * 
	 * @param resteasyServiceName
	 *            nome della resource class in cui iniettare i bean di spring
	 */
