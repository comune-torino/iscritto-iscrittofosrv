 ...
 * 
 */
@WebFault(name = "fault2", targetNamespace = "urn:SrvVisuraFamiglia")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: it.csi.iscritto.iscrittofosrv.integration.service.nao.client.SystemException
     */
